//
//  TransferViewCustomStrategy.swift
//  Directions
//
...
class TransferViewCustomStrategy: ScannerStrategy {
    ...
    func go(code: String) -> UIViewController {
        ...
        viewController.setCode(code, type: TransferProductViewController.CODE_TYPE_TRANSFER.CUSTOM)
